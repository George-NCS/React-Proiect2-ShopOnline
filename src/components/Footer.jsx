            ...
            <div className="container-fluid container-min-max-width
                ...
                <div>
                    ...
                    <p className="mb-1">
                        ...
                        <a href="mailto:neacsugeorge95@yahoo.com">
                            <Mail className="mr-1 mb-1 footer-icon"/>
                            neacsugeorge95@yahoo.com
                        </a>
                    </p>
                    <p className="m-0"><Phone className="mr-1 footer-icon"/>+40766886074</p>
                </div>
                {/* Coloana 3: link-uri externe. */}
                <div>
                    <h3 className="h5">Contactează-mă:</h3>
                    <p className="mb-1">
                        <a href="https://github.com/George-NCS">
                            <GitHub className="mr-1 mb-1 footer-icon"/>
                            George-NCS
                        </a>
                    </p>
                    <p className="m-0">
                        <a href="https://www.linkedin.com/in/george-neacsu-982382199/">
